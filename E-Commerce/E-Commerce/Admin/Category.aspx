<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="E_Commerce.Admin.Category" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        window.onload = function () {
            var seconds = S;
            setTimeout(function () {
                doument.getElementById("<%= label_msg.ClientID %>").style.display = "none";
            }, seconds * 1000);
        }
    </script>
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-action pb-5">
                            <div class="text-left">
                                ...
                                <asp:Button ID="btnClear" runat="server" CssClass="btn btn-info" Text="Reset" OnClick="btnClear_Click"/>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                            <asp:Repeater ID="rCategory" runat="server" OnItemCommand="rCategory_ItemCommand">
                                ...
                                <HeaderTemplate>
                                    <table class="table table-bordered  data-table-export table-hover nowrap">
                                        <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th>Image</th>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <img width="40" src="<%# E_Commerce.Utils.getImageUrl(Eval("CategoryImageUrl")) %>" alt="image" />
                                        </td>
                                        <td>
